...
const SCENES = [
  ...
  // ── 二期放开场景(2026-09-22 放开 W3/W4/W7/W9; W5 探店/W6 演出 已终止不做) ──
  {
    code: 'W3', name: '健身陪伴', icon: '🏋️', color: '#E8FFF0', gb: false, cert: '健身认证',
    disclaimer: {
      title: '健身陪伴免责声明',
      content: '健身陪伴仅提供运动陪同、动作监督与打卡督促，耍伴不提供专业训练指导、运动康复或医疗建议，不具备执业医师、康复治疗师资格。请在服务开始前如实告知自身健康状况，患有心血管疾病、骨关节疾病或其他不适合运动的疾病时须遵医嘱并谨慎参与。运动前请充分热身、量力而行，切勿在无人指导下尝试大重量或高难度动作。因你自身健康原因、未如实告知或擅自加大运动强度导致的运动伤害，平台与耍伴不承担责任。建议自行购买运动意外险。'
    },
    options: ['健身指导', '跑步陪跑', '器械陪同']
  },
  {
    code: 'W4', name: '游玩陪伴', icon: '🎡', color: '#FFF0E8', gb: false, cert: '游玩认证',
    disclaimer: {
      title: '游玩陪伴免责声明',
      content: '游玩陪伴仅提供同行陪同、路线协助与游览陪伴，不提供导游讲解等需资质许可的服务。服务仅限对公众开放的景区、场馆、商圈等公共场所，严禁进入住宅、酒店客房、私密包间等非公开空间，一经发现平台有权立即中止订单。景区门票、交通、餐饮等费用由你自行承担。因景区管理调整、天气、场馆闭馆等第三方原因导致的行程变更或损失，平台与耍伴不承担责任。请遵守景区与场馆规定，注意保管随身财物与人身安全。'
    },
    options: ['景区游览', '博物馆参观', '商圈逛街']
  },
  {
    code: 'W7', name: '情绪陪伴', icon: '🫂', color: '#FFE8F3', gb: false, cert: '情绪认证',
    disclaimer: {
      title: '情绪陪伴免责声明',
      content: '情绪陪伴仅提供公共场所内的倾听、陪伴散步与情感支持，不提供心理咨询、心理疏导、心理治疗或任何形式的诊疗服务，耍伴不具备心理咨询师执业资格，不得进行心理评估、干预或诊断。服务全程仅限公园、商圈、图书馆等公共场所，请勿在私密空间独处。如你或对方出现自伤、自杀等危机倾向，请立即拨打 120/110 或全国心理援助热线，耍伴与平台将协助联系专业资源，但不承担诊疗与救治责任。服务中请勿透露银行卡密码、短信验证码等敏感信息。'
    },
    options: ['陪伴散步', '倾听陪伴', '考前鼓励']
  },
  {
    code: 'W9', name: '宠物陪伴', icon: '🐾', color: '#E8F5FF', gb: false, cert: '宠物认证',
    disclaimer: {
      title: '宠物陪伴免责声明',
      content: '宠物陪伴仅提供遛狗、喂猫、陪同宠物就医等协助性服务，耍伴不提供宠物诊疗、用药建议、疫苗接种等兽医服务。宠物须已完成疫苗接种并具备合法饲养手续；按 R9 资质红线要求，接单耍伴须出示宠物照料授权凭证后方可提供服务。服务期间请确保宠物佩戴牵引绳与必要的防护用具，遵守当地养犬管理规定，勿在禁入场所携宠。因宠物应激反应、突发疾病、走失或对第三方造成人身、财产损害所产生的责任，由宠物主人依法承担，平台与耍伴不承担超出协助义务的责任。'
    },
    options: ['遛狗陪伴', '喂猫照料', '宠物就医陪同']
  }
];
